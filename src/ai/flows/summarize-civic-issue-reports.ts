...
const summarizeCivicIssuesPrompt = ai.definePrompt({
  ...
  If the query is a greeting or not a question, respond politely. If asked for specific reports, list them clearly. If asked for a summary, provide a high-level overview. When asked about upvotes, use the 'Upvotes' data point.
  `,
});
